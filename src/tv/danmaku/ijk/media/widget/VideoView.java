...
public class VideoView extends SurfaceView implements
	...
	public void setVideoLayout(int layout) {
		...
		if (mVideoHeight > 0 && mVideoWidth > 0) {
			...
			// new add start
			// set the video 銆乿ideoview淇濇寔涓�嚧锛寃indow鏆傛椂涓嶄娇鐢�
			lp.width = mSurfaceWidth = getWidth();
			lp.height = mSurfaceHeight = getHeight();
			// new add end
